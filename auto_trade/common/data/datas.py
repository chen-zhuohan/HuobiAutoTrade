...
# from auto_trade.common.data import calculate_DN, calculate_ma20, calculate_vol_vol3, calculate_UN
# from auto_trade.common.data import BaseCalculateData, BaseQueryData
#
#
